...
global.dir = vim.fn.stdpath("cache") .. "/cmp-adaptive-freq-autosave/global.mpack"

local function save_global_data(word_id_map, uni, relation_map, pairing_map)
    if not dirty or autosave.dir == "" then return end
...
function global.save(word_id_map, unigram_cms, relation_map, pairing_map)
	save_data(word_id_map, unigram_cms, relation_map, pairing_map)
end
--- Initialize autosave system
function global.setup(word_id_map, unigram_cms, relation_map, pairing_map)
    -- Wrap increment methods to mark dirty
    local original_increment = unigram_cms.increment
    unigram_cms.increment = function(self, key)
        mark_dirty()
...
--- =================================== ---
save.session_dir = vim.fn.stdpath("cache") .. "/cmp-adaptive-freq-autosave/session.mpack"
